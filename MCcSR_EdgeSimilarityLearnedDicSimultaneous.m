...
function [hIm] = MCcSR_EdgeSimilarityLearnedDicSimultaneous(lIm, up_scale, lambda, overlap, DicSize)
...
dict =  ['Dictionary/Color_D_' num2str(up_scale)  'x_'  num2str(DicSize)  '_0.1_0.001_5_RandInit1.mat'];

% load dictionary
% load('Dictionary/Color_D_3x_512_0.1_0.001_5_RandInit1.mat');
load(dict);
...
%             fprintf('C%.3f ',beta4)
            ...
            S_fista = FISTA_EdgeSimilarity(y_l,A_l, D ,lambda);
            S=S_fista;
            ...
            w_r = L1QP_FeatureSign_yang(lambda, A_r, b_r');
            w_g = L1QP_FeatureSign_yang(lambda, A_g, b_g');
            w_b = L1QP_FeatureSign_yang(lambda, A_b, b_b');
            S = [w_r ; w_g; w_b];
        end
